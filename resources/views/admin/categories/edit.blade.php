        ...
        <div
            ...
            <div class="w-full mb-1 mt-16">
                <div class="mb-4">
                        ...
                        <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#"
                                        class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Category</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
                    ...
                    <h1 class="text-xl px-4 font-semibold text-gray-900 sm:text-2xl dark:text-white">Create category</h1>
                </div>
                ...
                <div class="p-6 space-y-6">
                    <form id="CategoryForm" enctype="multipart/form-data">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <textarea name="description" id="description"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500 h-36"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <img src="{{ asset($category->image) }}" alt="Category image" class="w-60 h-auto mx-auto">
                            </div>
                        ...
                        <div class="col-span-6 flex justify-end items-end mt-6">
                            <button class="btn w-[200px] text-center flex-center" type="submit" id="submitBtn">Update
                                category</button>
                        </div>
                </div>
