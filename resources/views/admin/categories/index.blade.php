   ...
   <div class=" p-4 bg-white flex flex-col items-center justify-between lg:mt-1.5 ">
            <div class="w-full mb-1 mt-16">
                ...
                <div class="flex justify-between items-center">
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Manage categories
                    </h1>
                    <form action="{{ route('categories.index') }}" method="GET">
                        ...
                        <div class="relative lg:w-64 xl:w-96">
                            <input type="text" name="search" id=""
                                ...
                                placeholder="Search for categories" value="{{ $search }}">
                    ...
                    <a href="{{ route('categories.create') }}" class="btn-dark">New category</a>
                </div>
            </div>
                                    ...
                                    @foreach($categories as $category)
                                        ...
                                        <tr>
                                            ...
                                            <td
                                               ...
                                               @if ($category->status)
                                                    <span class="badge badge-blue mb-1">Active</span>
                                                @else
                                            ...
                                            <td class="p-2 whitespace-nowrap">
                                                <a href="{{ route('categories.edit', $category->id) }}" class="btn-sm">
                                                    <i class="fa-solid fa-user-pen"></i>
                                                </a>

                                                <a href="{{ route('categories.destroy', $category->id) }}"
                                                    class="btn-sm !bg-red-600 rounded-lg text-center ml-2">
                                                    <i class="fa-solid fa-trash-can text-center text-white mr-1"></i></a>
                                            </td>
                                        </tr>
