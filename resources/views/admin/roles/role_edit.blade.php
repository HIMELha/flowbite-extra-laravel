        ...
        <div
            ...
            <div class="w-full mb-1 mt-16">
                <div class="mb-4">
                        ...
                        <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#"
                                        class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">role</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
                    ...
                    <h1 class="text-xl px-4 font-semibold text-gray-900 sm:text-2xl dark:text-white">Edit role</h1>
                </div>
                    ...
                    <form id="RoleForm">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select name="permissions[]" class="w-full" id="permissions" multiple>
                                    ...
                                    @empty
                                        <option selected disabled>No permissions found</option>
                                    @endforelse
                                </select>
                ...
                <div class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                    <button
                        ...
                        type="submit" id="submitBtn">Update role</button>
                </div>
                </form>
            </div>
        </div>
        ...
        $(document).ready(function() {
           $('#permissions').select2();
            ...
            $('#RoleForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('roles.updateRole', $role->id) }}",
                    beforeSend: function() {
