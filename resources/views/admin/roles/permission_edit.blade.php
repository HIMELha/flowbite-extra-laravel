        ...
        <div
            ...
            <div class="w-full mb-1 mt-16">
                <div class="mb-4">
                    ...
                    <h1 class="text-xl px-4 font-semibold text-gray-900 sm:text-2xl dark:text-white">Edit permission</h1>
                </div>
                ...
                <div class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                    <button
                        ...
                        type="submit" id="submitBtn">Update permission</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#PermissionForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('roles.updatePermission', $permission->id) }}",
                    beforeSend: function() {
                    ...
                    success: function(response) {
                        ...
                        submitBtn.html("Update permission");
