                                ...
                                <li class="py-3 sm:py-4">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center min-w-0">
                                            <img class="flex-shrink-0 w-10 h-10" src="https://fdn2.gsmarena.com/vv/pics/apple/apple-iphone-14-pro-max-1.jpg"
                                                alt="imac image">
                                            <div class="ml-3">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            var chart = new ApexCharts(document.querySelector("#traffic-by-device"), options);
            chart.render();
