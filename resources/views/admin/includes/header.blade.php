    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                <!-- Dropdown menu -->
                <div class="z-20 hidden absolute top-14 right-10 max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                ...
                <!-- Dropdown menu -->
                <div class="z-20 absolute top-14 right-6 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                    id="tooltipDropdown">
                    <div
                        class="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        Apps
                ...
                <div class="flex items-center ml-3">
                    ...
                    <!-- Dropdown menu -->
                    <div class="z-50 hidden w-[200px] absolute top-14 right-0 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        id="profileDropdown">
                        <div class="px-4 py-3 flex flex-wrap gap-1" role="none">
